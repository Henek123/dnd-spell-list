  ...
  return (
    <section className='overlay'>
        <div className="overlay-container">
          ...
          {
            cantrips.length > 0 &&
            <h1><span onClick={() => setShowCantrips(prevState => !prevState)}>
              Cantrips {showCantrips ? "↑" : "↓"}
            </span></h1>
          }
          ...
          {
            level1.length > 0 &&
            <h1><span onClick={() => setShowLevel1(prevState => !prevState)}>
              Level 1 {showLevel1 ? "↑" : "↓"}
            </span></h1>}
          {showLevel1 && level1}
          {
          ...
          {
            level2.length > 0 &&
            <h1><span onClick={() => setShowLevel2(prevState => !prevState)}>
              Level 2 {showLevel2 ? "↑" : "↓"}
            </span></h1>}
          {showLevel2 && level2}
          {
          ...
          {
            level3.length > 0 &&
            <h1><span onClick={() => setShowLevel3(prevState => !prevState)}>
              Level 3 {showLevel3 ? "↑" : "↓"}
            </span></h1>}
          {showLevel3 && level3}
          {
          ...
          {
            level4.length > 0 &&
            <h1><span onClick={() => setShowLevel4(prevState => !prevState)}>
              Level 4 {showLevel4 ? "↑" : "↓"}
            </span></h1>}
          {showLevel4 && level4}
          {
          ...
          {
            level5.length > 0 &&
            <h1><span onClick={() => setShowLevel5(prevState => !prevState)}>
              Level 5 {showLevel5 ? "↑" : "↓"}
            </span></h1>}
          {showLevel5 && level5}
          {
          ...
          {
            level6.length > 0 &&
            <h1><span onClick={() => setShowLevel6(prevState => !prevState)}>
              Level 6 {showLevel6 ? "↑" : "↓"}
            </span></h1>}
          {showLevel6 && level6}
          {
          ...
          {
            level7.length > 0 &&
            <h1><span onClick={() => setShowLevel7(prevState => !prevState)}>
              Level 7 {showLevel7 ? "↑" : "↓"}
            </span></h1>}
          {showLevel7 && level7}
          {
          ...
          {
            level8.length > 0 &&
            <h1><span onClick={() => setShowLevel8(prevState => !prevState)}>
              Level 8 {showLevel8 ? "↑" : "↓"}
            </span></h1>}
          {showLevel8 && level8}
          {
          ...
          {
            level9.length > 0 &&
            <h1><span onClick={() => setShowLevel9(prevState => !prevState)}>
              Level 9 {showLevel9 ? "↑" : "↓"}
            </span></h1>}
          {showLevel9 && level9}
          {
